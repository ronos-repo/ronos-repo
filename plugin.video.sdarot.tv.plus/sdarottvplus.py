...
__image_path__ = ''
__settings__ = xbmcaddon.Addon(id='plugin.video.sdarot.tv.plus')
...
def sdarot_series(url):
  ...
  #  print "sdarot_series: Fetching URL:"+url  
    ...
    for season in matches:
        downloadMenu = []
        if downloadEnabled:
            downloadUrl = "XBMC.RunPlugin(plugin://plugin.video.sdarot.tv.plus/?mode=7&url=" + url + "&season_id="+str(season)+"&series_id="+str(series_id) + ")"
